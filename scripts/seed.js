...
async function main() {
  ...
  // 1. Admin account
  const email = (process.env.ADMIN_EMAIL || 'admin@tirupurcotton.com').toLowerCase();
  ...
  if (!existingSettings) {
    await Settings.create({
      key: 'global',
      storeName: 'Tirupur Clothing Hub',
      whatsapp: '918056114537',
      instagram: 'Tirupur Clothing Hub',
      address: 'Tirupur, Tamil Nadu',
      shippingFee: 49,
      freeShippingAbove: 999,
      seoTitle: 'Tirupur Clothing Hub',
      seoDescription: 'Shop trendy women kurtis from Tirupur Clothing Hub, Tirupur.'
    });
